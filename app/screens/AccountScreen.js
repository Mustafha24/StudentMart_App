...
LogBox.ignoreLogs([
  ...
  "screen with the same name nested inside one another"
]);
...
const AccountScreen = ({ navigation }) => {
  ...
  const onPhotoUploadPressed = async (type) => {
    ...
    let folderPath = type === "profile" ? "profilePhoto" : "coverPhoto";

    const storageRef = ref(storage, `/${folderPath}/${user._id}/${filename}`);
